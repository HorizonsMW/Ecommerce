...
const { createProduct, getAProduct, getRelatedProducts, getAllProducts, updateProduct, deleteAProduct, getAllProductsSorted } = require("../../controller/productCtrl");
...
router.get("/related", getRelatedProducts);//get related products
